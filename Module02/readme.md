...
1. Установлен Docker по видео курсу Установка Docker Скриншот установки Docker

2. Установлен PostgreSQL по инструкции Установка Postgres на Docker Скриншот установки Postgres

3. Установлена программа DBSchema для проектирования базы данных. Скриншот установки DBSchema

4. Установлен SQL-клиент DBeaver для подключения базы данных. Скриншот установки DBeaver
